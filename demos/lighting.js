...
(async () => {
    ...
    let skyboxDrawCall = app.createDrawCall(skyboxProgram, skyboxArray)
        .texture("cubemap", app.createCubemap({
            negX: await loadTexture("1.jpg"),
            posX: await loadTexture("1.jpg"),
            negY: await loadTexture("1.jpg"),
            posY: await loadTexture("1.jpg"),
            negZ: await loadTexture("1.jpg"),
            posZ: await loadTexture("1.jpg")
        }));
...
function draw() {
    ...
    mat4.perspective(projectionMatrix, Math.PI / 4, app.width / app.height, 1, 100.0);
